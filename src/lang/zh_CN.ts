...
const lang = {
    ...
    settings: {
        ...
        translationUseIndependent: "独立 AI 翻译通道",
        translationBaseUrl: "翻译 Base Url",
        translationModelId: "翻译模型 ID（空则沿用主模型）",
        translationModelRefresh: "拉取模型",
        translationModelLoading: "拉取中…",
        translationModelRefreshed: "已拉取 {count} 个模型",
        translationModelNeedsChannel: "请先填写独立翻译的 Base Url（Key 可空）",
        translationModelEmpty: "该通道未返回可用模型",
        translationModelFailed: "拉取翻译模型列表失败",
        advanced: "高级设置",
        debugMode: "调试模式",
        debugInfo: "调试信息",
        pages: {
