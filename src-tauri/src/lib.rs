...
/// 探测本地端口是否已有进程监听。
///
/// 本地端口试探：若直接用 fetch 试探端口，WebKit 会把每次失败都当成
...
pub fn run() {
    ...
    builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            nexus_collection::nexus_collection_info,
            nexus_collection::nexus_collection_files,
            nexus_collection::collection_pending_list,
            nexus_collection::collection_pending_save,
            nexus_collection::collection_pending_update_item,
            nexus_collection::collection_pending_remove,
            nexus_collection::collection_pending_clear_finished,
